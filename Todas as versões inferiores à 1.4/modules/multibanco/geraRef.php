...
/*Função original Criada por José Franco para Ondesk TI
* www.onidesk.com
* franco@onidesk.com
* Adaptada e modificada por Ehinarr Elkader
* para uso exclusivo no PrestaShop
*****************************/
...
function geraRef($order_id, $order_value)
{
    $ent_id      = $_POST['ent_id'];
...
echo geraRef($order_id, $order_value);
?>

		...
		<div class="panel">
			...
			<div id="info">
				<table style="font-family: Verdana,sans-serif; font-size: 11px; color: black; width: 278px;">
					...
					<br /><br />
					<div>
						<a href="../?fc=module&module=multibanco&controller=update&order_id={$order_id}&folder={$url_folder}&token={$token}" class="btn btn-primary">Atualizar Dados Multibanco</a>
						&nbsp;&nbsp;

...
{
    const FLAG_DISPLAY_PAYMENT_INVITE = 'IFTHENPAY_MULTIBANCO_PAYMENT_INVITE';
	...
	function hookDisplayOrderDetail($params)
	{
		...
		return $this->fetch(_PS_MODULE_DIR_ . 'multibanco/views/templates/hook/history.tpl');
	}
	...
	public function hookPayment($params)
	{
		...
		return $this->fetch(_PS_MODULE_DIR_ . 'multibanco/views/templates/hook/payment.tpl');
	}
